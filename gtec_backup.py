...
try:
    ...
    print("Error: ldparser not found. Please ensure it is cloned in the current directory.")
    sys.exit(1)
...
def show_splash_screen():
    ...
    *                                                          *
    *          Copyright Gomez Systems Group, 2026             *
    *                 All rights reserved                      *
    ************************************************************
    """
    print(splash)
    ...
    while time.time() < end_time:
        sys.stdout.write(f"\r  Initializing System {spinner[i % len(spinner)]} ")
        sys.stdout.flush()
        time.sleep(0.1)
        i += 1
    print("\n\n  Ready.")
