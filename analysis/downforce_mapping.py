                ...
                if ans == 'open l1':
                    ...
                    def generate_2d_plot(f_data, r_data, z_data, title, filename):
                        ...
                        try:
                            ...
                            triang.set_mask(distances > threshold)
                            contourf = plt.tricontourf(triang, z_s, levels=20, cmap=opendav_cmap, extend='both', alpha=0.9)
                            lines = plt.tricontour(triang, z_s, levels=10, cmap=opendav_cmap, linewidths=1.5, alpha=0.8)
                            plt.clabel(lines, inline=True, fontsize=9, fmt='%d N', colors='white')
                            plt.colorbar(contourf, label='Total Downforce (N)')
                    ...
                    def plot_2d_ax(ax, f_s, r_s, z_s, title, subtitle=""):
                        ...
                        ax.clabel(lines, inline=True, fontsize=9, fmt='%d N', colors='white')
