...
def run_downforce_mapping(sessions, headless=False, headless_config=None):
    while True:
        ...
        for session in sessions:
            ...
            static_mask = (speed_kmh < 8) & (np.abs(lat_g) < 0.09) & (np.abs(long_g) < 0.09)
            ...
            aero_mask = (speed_kmh > 100.0) & bump_mask
 ...
 └─────────────────────────────────────────┘   └─────────────────────────────────────────┘      
  ...
  >> [USE CASE]: DIRECTLY COMPARE AERODYNAMIC TOPOGRAPHY SHIFTS BETWEEN TWO SETUP ITERATIONS."""
            print(l2_preview)
            print(f"""
        L4: DYNAMIC AERO ANIMATION (.MP4)
 ┌───────────────────────────────────────────────────────────────────────────────────┐
 │                                                                                   │
 │      [ G-PLOT ]                             [ AERO CONTOUR ]                      │
 │   (Friction Circle)                        (Rolling 150-pt Window)                │
 │                                                                                   │
 │                                                                                   │
 │                                                                                   │
 │                                      [ TIME SERIES ]                              │
 ...
 └───────────────────────────────────────────────────────────────────────────────────┘
  ...
  >> [USE CASE]: RENDER A HIGH-QUALITY VIDEO OF DYNAMIC RIDE HEIGHT & AERO BALANCE.
